...
export const BLOG_ARTICLES: BlogArticle[] = [
  {
    ...
    status: "coming_soon",
    titles: {
      ru: "Как выбрать адвоката в Алматы",
      kz: "Алматыда адвокатты қалай таңдау керек",
      en: "How to choose a lawyer in Almaty",
    },
    excerpts: {
      ru: "Практические критерии выбора адвоката: опыт, специализация, прозрачность и этика.",
      kz: "Адвокат таңдаудың нақты критерийлері: тәжірибе, мамандану, ашықтық.",
